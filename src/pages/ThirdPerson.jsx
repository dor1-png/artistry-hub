      ...
      <section className="py-32 px-8 bg-white" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        <div className="max-w-4xl mx-auto">
          <div className="space-y-16">
            ...
            >
              <h1 className="text-6xl md:text-7xl font-light tracking-tight">Third Person</h1>
              
              <div className="space-y-6">
                <p className="text-lg font-light text-gray-600 leading-relaxed">
                  An investigation into perspective and embodiment. Third Person explores the distance between performer and observer through ritualistic movement and spatial awareness.
                </p>
                <p className="text-lg font-light text-gray-600 leading-relaxed">
                  In this work, the body becomes a site of inquiry. The performer navigates the liminal space between being seen and being invisible, questioning who observes whom and what that relationship means. Through controlled, precise movement, the work invites the audience to consider their own perspective and complicity in witnessing.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-xl font-light text-gray-900">2024</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-light tracking-widest text-gray-500 uppercase">Duration</p>
                  <p className="text-xl font-light text-gray-900">14 minutes</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-light tracking-widest text-gray-500 uppercase">Disciplines</p>
                  <p className="text-xl font-light text-gray-900">Physical Theatre</p>
                </div>
                <div className="space-y-2">
                  <p className="text-xs font-light tracking-widest text-gray-500 uppercase">Location</p>
                  <p className="text-xl font-light text-gray-900">Tel Aviv</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex justify-between items-center py-8 border-b border-gray-300 group-hover:border-gray-900 transition-colors">
              <span className="text-2xl md:text-3xl font-light tracking-tight">Eclecticism</span>
