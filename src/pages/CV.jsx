...
export default function CV() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Top Bar */}
      <div className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-gray-100 z-40 px-8 py-5 flex justify-between items-center">
        <button
          onClick={() => navigate('/')}
          className="flex items-center gap-3 text-xs font-light tracking-widest text-gray-500 hover:text-gray-900 transition-colors uppercase"
        >
          <ArrowLeft size={14} />
          Back
        </button>
        <button
          ...
          className="flex items-center gap-3 border border-gray-800 px-6 py-2.5 text-xs font-light tracking-widest hover:bg-gray-800 hover:text-white transition-all duration-400"
        >
          <Download size={13} />
          Download CV
        </button>
